        ...
        <div class="row book_card">
          ...
          <div class="col-6 d-flex flex-column justify-content-between">
            <div class="book_detail">
              ...
              <div>
                <span class="new_price">${book.price}₺</span>
                ${
                  book.oldPrice
                    ? `<span class="old_price">${book.oldPrice}₺</span>`
                    :""
            }
              </div>
...
const listBasketItems=()=>{
  ...
  basketCountEl.innerHTML=basketList.length > 0 ? basketList.lenght: null;
  ...
  basketListEl.innerHTML=basketListHtml
   ? basketListHtml
   :`<li class="basket_item">SEPETİNİZ BOŞ.</li>`
  ...
  if(findedBook){
    ...
    if(basketAlreadyIndex==-1){
      ...
      if (
        ...
        toastr.error("Üzgünüz, Ürün Tükendi."); 
      return}; 
...
const increaseItemToBasket=(bookId)=>{
  ...
  if(findedIndex!=-1){
    if (
      ...
      basketList[findedIndex].quantity += 1;
    else toastr.error("Üzgünüz, Ürün Tükendi.");
    listBasketItems();
  }
}
